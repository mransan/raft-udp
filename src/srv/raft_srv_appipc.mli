(** Application IPC handles the communication between the RAFT server and 
    the App server 
 
    In RAFT application the APP server is responsible to handle the validation 
    of the log data and to apply the log data to its state. 
  *)
